...
function App() {
  ...
  useEffect(() => {
    socket.current = io.connect("https://gitsalahcall.herokuapp.com/");
  ...
  function callPeer(id) {
    if(id!=='' && users[id] && id!==yourID){
      ...
      .catch(()=>{
        setModalMessage('You cannot place/ receive a call without granting video and audio permissions! Please change your settings to use Gitsalahcall.')
